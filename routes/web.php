...
Route::group([
    ...
    Route::get('orders', 'Orders\IndexController')->name('order-history');
    Route::get('orders/{uuid}', 'OrderController@getAction')->name('order.view');
    Route::get('orders/{uuid}/download', 'Orders\DownloadController')->name('order.download');
