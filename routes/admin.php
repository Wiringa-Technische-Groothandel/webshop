    ...
    function () {
        Route::group(
            ...
            function () {
                ...
                Route::post('api/login', 'Api\\Auth\\LoginController')->name('api.login');
            }
        );
        ...
        Route::group(
            ...
            function () {
                Route::group(
                    [
                        'middleware' => 'auth:airlock-admin'
                    ],
                    function () {
                        Route::get('me', 'Auth\\MeController')->name('me');

                        Route::post('logout', 'Auth\\LogoutController')->name('logout');

                        Route::group(
                            ['prefix' => 'companies', 'namespace' => 'Companies'],
                            function () {
                        ...
                        Route::group(
                            ['prefix' => 'carousel', 'namespace' => 'Carousel'],
                            function () {
                        ...
                        Route::group(
                            ['prefix' => 'products', 'namespace' => 'Catalog'],
                            function () {
                        ...
                        Route::group(
                            ['prefix' => 'search-terms', 'namespace' => 'SearchTerms'],
                            function () {
