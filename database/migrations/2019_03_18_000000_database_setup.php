...
class DatabaseSetup extends Migration
{
    ...
    private function runMigrations()
    {
            ...
            foreach ($oldCompanies as $company) {
                ...
                \DB::table('companies')->insert(
                    [
                        ...
                        'created_at'      => $company->created_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $company->created_at,
                        'updated_at'      => $company->updated_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $company->updated_at,
                    ]
                );
            }
        }
        ...
        \DB::statement(
            'UPDATE addresses SET id = ? WHERE id = ?',
            [
                Address::DEFAULT_ID,
                $address->getId(),
            ]
            ...
            foreach ($oldAddresses as $address) {
                ...
                \DB::table('addresses')->insert(
                    [
                        ...
                        'created_at' => $address->created_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $address->created_at,
                        'updated_at' => $address->updated_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $address->updated_at,
                    ]
                );
            }
        }
        ...
        Schema::create(
            'customers',
            function (Blueprint $table) use ($userRoleId) {
                $table->increments('id');
            ...
            foreach ($oldCustomers as $customer) {
                ...
                $customerId = \DB::table('customers')->insertGetId(
                    [
                        ...
                        'active'     => true,
                        'created_at' => $customer->created_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $customer->created_at,
                        'updated_at' => $customer->updated_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $customer->updated_at,
                    ]
                );
            ...
            foreach ($oldOrders as $order) {
                ...
                $orderId = \DB::table('orders')->insertGetId(
                    [
                        ...
                        'created_at'      => $order->created_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $order->created_at,
                        'updated_at'      => $order->updated_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $order->updated_at,
                    ]
                );
            ...
            foreach ($oldCarousel as $carouselItem) {
                ...
                \DB::table('carousel')->insert(
                    [
                        ...
                        'created_at' => $carouselItem->created_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $carouselItem->created_at,
                        'updated_at' => $carouselItem->updated_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $carouselItem->updated_at,
                    ]
                );
            }
        }
        ...
        if (! app()->environment('testing')) {
            ...
            foreach ($oldPacks as $pack) {
                ...
                $packId = \DB::table('packs')->insertGetId(
                    [
                        'product_id' => $product->id,
                        'created_at' => $pack->created_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $pack->created_at,
                        'updated_at' => $pack->updated_at === '0000-00-00 00:00:00' ?
                            '1970-01-01 01:00:00' : $pack->updated_at,
                    ]
                );

                $oldPackProducts = \DB::connection('mysql-old')
                    ->table('pack_products')
