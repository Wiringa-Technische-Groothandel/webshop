        ...
        <div class="modal-content">
            <form method="POST" class="form form-horizontal">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Product toevoegen') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="title">{{ __('Aantal') }}*</label>
                        <input class="form-control" maxlength="100" value="{{ old('amount') }}"
                               placeholder="{{ __('Aantal') }}" type="number" name="amount" required>
                    </div>
                </div>
